...
<body>
	<div id="content">
		...
		<div id="footer">
		      <p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <?=date("d.m.Y"); ?><a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>